...
export default function Customer() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch("https://formspree.io/f/xeewnyzy", {
        method: "POST",
...
<Helmet>
  ...
  <title>힐스테이트 고덕엘리스트 | 관심고객등록</title>

  <meta
    name="description"
    content="힐스테이트 고덕엘리스트 관심고객등록 안내. 평택 고덕국제화계획지구 A31BL·A34BL·A35BL에 조성되는 총 2,122세대 브랜드 대단지의 분양 정보, 청약 일정, 모델하우스 소식 및 주요 안내를 가장 먼저 확인하세요."
  />

  <meta
    name="keywords"
    content="힐스테이트 고덕엘리스트 관심고객등록, 평택 힐스테이트 고덕엘리스트, 고덕국제화계획지구 A31BL, 고덕국제화계획지구 A34BL, 고덕국제화계획지구 A35BL, 평택 아파트 분양, 힐스테이트 고덕엘리스트 청약, 힐스테이트 고덕엘리스트 모델하우스, 고덕국제신도시 아파트"
  />
  ...
  <meta
    property="og:title"
    content="힐스테이트 고덕엘리스트 | 관심고객등록"
  />

  <meta
    property="og:description"
    content="힐스테이트 고덕엘리스트 관심고객 등록 시 분양 일정, 모델하우스 소식, 청약 정보 등 주요 안내를 우선 받아보세요."
  />
  ...
  <meta
    ...
    content="힐스테이트 고덕엘리스트 관심고객 등록으로 분양 일정, 청약 정보, 모델하우스 소식을 확인하세요."
  />
      ...
      <div className={styles.customerWrap}>
        ...
        <div className={styles.customerLeft}>
          <div className={styles.textBlock}>
            <h2 className={styles.projectName}>힐스테이트 고덕엘리스트</h2>
