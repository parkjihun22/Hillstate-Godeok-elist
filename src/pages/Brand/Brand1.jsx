...
<Helmet>
  <title>힐스테이트 고덕엘리스트 | 브랜드 소개</title>

  <meta
    name="description"
    content="힐스테이트 고덕엘리스트 브랜드 소개. 평택 고덕국제화계획지구 A-67BL에 들어서는 브랜드 아파트의 주거 가치, 입지환경, 생활 인프라와 미래가치를 소개합니다."
  />

  <meta
    name="keywords"
    content="힐스테이트 고덕엘리스트 브랜드소개, 평택 힐스테이트 고덕엘리스트, 고덕국제화계획지구 A-67BL, 평택 고덕 아파트, 고덕신도시 아파트, 힐스테이트 고덕엘리스트 브랜드"
  />
  ...
  <meta
    property="og:title"
    content="힐스테이트 고덕엘리스트 | 브랜드 소개"
  />

  <meta
    property="og:description"
    content="평택 고덕국제화계획지구 A-67BL 힐스테이트 고덕엘리스트의 브랜드 가치와 주거 프리미엄을 소개합니다."
  />
...
<p className={styles.screenReaderOnly}>
  힐스테이트 고덕엘리스트 브랜드 소개 페이지입니다.
  평택 고덕국제화계획지구 A-67BL에 조성되는 힐스테이트 고덕엘리스트의 브랜드 가치와 주거 철학,
  생활 인프라, 쾌적한 단지 환경, 미래가치를 소개합니다.
  힐스테이트 고덕엘리스트는 실용적인 공간 설계와 품격 있는 주거 환경을 바탕으로
  새로운 주거 가치를 제안합니다.
</p>

<div className={`${styles.textBox} ${isTextVisible ? styles.active : ''}`}>
  <div>평택 고덕국제화계획지구의 생활을 가까이</div>
  <div>힐스테이트 고덕엘리스트, 새로운 주거 가치</div>
</div>

<img
  className={`${styles.image} ${isImageVisible ? styles.visible : ''}`}
  src={page1}
  alt="힐스테이트 고덕엘리스트 브랜드 소개 및 고덕국제화계획지구 주거 가치 이미지"
/>
            <Footer />
        </div>
    );
