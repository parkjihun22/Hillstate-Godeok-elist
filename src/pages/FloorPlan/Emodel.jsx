...
<Helmet>
  {/* 핵심 SEO 페이지: E모델하우스 */}
  <title>힐스테이트 고덕엘리스트 | E모델하우스</title>

  <meta
    name="description"
    content="힐스테이트 고덕엘리스트 E모델하우스 안내. 평택 고덕국제화계획지구 A31BL·A34BL·A35BL에 조성되는 총 2,122세대 브랜드 대단지의 58㎡·84㎡ 세대 평면, 실내 구조, 공간 구성과 주거 동선을 온라인으로 확인하세요."
  />

  <meta
    name="keywords"
    content="힐스테이트 고덕엘리스트 E모델하우스, 평택 힐스테이트 고덕엘리스트 모델하우스, 고덕국제화계획지구 A31BL, 고덕국제화계획지구 A34BL, 고덕국제화계획지구 A35BL, 힐스테이트 고덕엘리스트 평면도, 평택 고덕 아파트 모델하우스"
  />
  ...
  <meta property="og:title" content="힐스테이트 고덕엘리스트 | E모델하우스" />
  ...
  <meta name="twitter:title" content="힐스테이트 고덕엘리스트 | E모델하우스" />
...
<p className={styles.screenReaderOnly}>
  힐스테이트 고덕엘리스트 E모델하우스 페이지입니다.
  평택 고덕국제화계획지구 A31BL·A34BL·A35BL에 조성되는 총 2,122세대 규모의
  힐스테이트 고덕엘리스트 58㎡·84㎡ 세대 평면, 실내 구조,
  공간 구성과 주거 동선을 온라인으로 확인할 수 있습니다.
</p>

<div className={styles.textBox}>
  <div>평택 고덕국제화계획지구의 58㎡·84㎡ 주거 공간을 온라인으로 확인</div>
  <div>힐스테이트 고덕엘리스트 E모델하우스를 살펴보세요.</div>
</div>
      ...
      <h1 className={styles.screenReaderOnly}>힐스테이트 고덕엘리스트- E모델하우스</h1>
