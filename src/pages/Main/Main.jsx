...
const section3Contents = [
  {
    ...
    title: "PREMIUM 01",
    text1: `총 2,122세대 브랜드 대단지`,
    text2: `A31BL·A34BL·A35BL<br/> 총 2,122세대 규모<br/>
            고덕을 대표하는 프리미엄 주거단지`,
  ...
  },
  {
    ...
    title: "PREMIUM 02",
    text1: `삼성전자 평택캠퍼스 직주근접`,
    text2: `세계 최대 규모 삼성전자 평택캠퍼스<br/>
            풍부한 배후수요를 누리는 프리미엄`,
  ...
  },
  {
    ...
    title: "PREMIUM 03",
    text1: `SRT 지제역 광역 교통망`,
    text2: `SRT 지제역과 광역 교통망 이용 편리<br/>
            수도권과 전국을 연결하는 우수한 교통환경`,
    link: "/LocationEnvironment/intro",
    linkText: "더 알아보기 >",
  },
  {
    ...
    title: "PREMIUM 04",
    text1: `고덕국제신도시 미래가치`,
    text2: `생활·교육·상업 인프라를 가까이 누리는 환경<br/>
            미래가치를 모두 갖춘 프리미엄 라이프`,
...
<div className={styles.imageContainer}>
  ...
  <div className={styles.mainImageTextBox}>
    ...
    <div className={styles.mainImageTitleBox}>
      ...
      <div className={styles.mainImageDesc}>
        평택 고덕국제화계획지구 A31BL·A34BL·A35BL에 조성되는 총 2,122세대 브랜드 대단지<br/>
        삼성전자 평택캠퍼스 배후수요와 SRT 지제역 생활권을 누리는 프리미엄 입지<br/>
        고덕의 미래가치를 담은 힐스테이트 고덕엘리스트
      </div>
            ...
            <div className={styles.section1}>
              <div className={styles.textBox}>
                ...
                <div className={styles.text3}>
                  - A31BL·A34BL·A35BL 총 2,122세대 브랜드 대단지 프리미엄<br />
                  - 삼성전자 평택캠퍼스 배후수요를 누리는 직주근접 입지<br />
                  - SRT 지제역 및 광역 교통망을 통한 편리한 이동 환경<br />
                  - 교육·상업·생활 인프라를 가까이 누리는 고덕국제신도시 생활권<br />
                  - 공원과 녹지 공간이 어우러진 쾌적한 힐스테이트 주거 설계
                </div>
          ...
          <div className={styles.section}>
            <div className={styles.section2}>
              ...
              <img
                src={section2_Image1}
                alt="힐스테이트 고덕엘리스트아파트 조감도-image3"
                loading="lazy"
                decoding="async"
              />
            </div>
          ...
          <div className={styles.section}>
            <div className={styles.section4}>
              <div className={styles.imageBox}>
                <img
                  src={section4_Image1}
                  alt="힐스테이트 고덕엘리스트브랜드소개-image4"
                  loading="lazy"
                  decoding="async"
                />
                <div className={styles.text1}>힐스테이트 고덕엘리스트</div>
          ...
          <div className={styles.pcVisitContainer}>
            ...
            <form
              ...
              action="https://formspree.io/f/xwvdpkgz"
              method="POST"
            >
              <label htmlFor="name">
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              ...
              <img src={map1} alt="힐스테이트 고덕엘리스트오시는길안내-image1" />
            </div>
          </div> */}
  ...
  <img
    src={mobileImageMain}
    className={styles.mainImage}
    alt="힐스테이트 고덕엘리스트 아파트 모바일 메인 이미지"
  />
  ...
  <div className={styles.mainImageTextBox1}>
    ...
    <div className={styles.mainImageTextSub1}>
      ...
      총 2,122세대 브랜드 대단지 프리미엄<br/>

      <span className={styles.greyText1}>
        브랜드 프리미엄과 미래가치를 함께 누리다
      </span>
      <br />
    </div>
    ...
    <div className={styles.mainImageTitleBox1}>
      ...
      <div className={styles.mainImageDesc1}>
        평택 고덕국제화계획지구 A31BL·A34BL·A35BL<br/> 조성되는 총 2,122세대 브랜드 대단지<br/>
        삼성전자 평택캠퍼스 배후수요<br/> SRT 지제역 생활권을 누리는 프리미엄 입지<br/>
        고덕국제신도시의 미래가치를 담은 힐스테이트 고덕엘리스트
      </div>
         ...
         <div className={styles.mobileMiddleImage}>
          ...
          <div className={styles.container3}>
            <div className={styles.textbox}>
              ...
              <div className={`${styles.text4} fadeUpRepeat`}>
                살수록 자부심이 차원이 다른
                <br />
                프리미엄 주거라이프를 <br /> 힐스테이트 고덕엘리스트에서<br />
                확인하세요
              </div>
            </div>
            <img
              src={section2_Image1}
              alt="힐스테이트 고덕엘리스트모바일 조감도 이미지"
              loading="lazy"
              decoding="async"
            />
          </div>
          ...
          {/* <div className={styles.container2}>
            <div>
              <img
                src={section1_Image1}
                alt="힐스테이트 고덕엘리스트브랜드소개 mobile-image5"
              />
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              <img
                src={mobilemap1}
                alt="힐스테이트 고덕엘리스트오시는길안내-mobileimage2"
              />
            </div>
          </div> */}
